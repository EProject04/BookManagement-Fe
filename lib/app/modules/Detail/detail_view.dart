                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(
                              ...
                              width: 150,
                              child: Container(
                                child: Image.network(pageController.bookDetail.imagePath),
                              ),
                            ),
                            Container(
                              width: 200,
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    pageController.bookDetail.title,
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      pageController.bookDetail.author,
                                      style: GoogleFonts.urbanist(
                                          textStyle: TextStyle(
                                              fontSize: 15,
                                              fontWeight: FontWeight.w600,
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              pageController.bookDetail.description,
                              style: GoogleFonts.urbanist(
                                textStyle: TextStyle(
                                  fontSize: 15,
